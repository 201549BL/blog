...
excerpt: This is an excerpt that is presented on the index page
---
...
{/* <StyledImage src={"/images/plants.jpg"} width={"1770"} height={"1180"} /> */}

<DynamicImage src={"/images/plants.jpg"} />

### A Third Level Header

# Hello mister

> this is a blockquote and this is a continuation liquorice react First then Last and if i were then I am not

<Aside type="success">This is a custom aside component render by MDX</Aside>
<Aside type="danger">This is a custom aside component render by MDX</Aside>
<Aside type="info">This is a custom aside component render by MDX</Aside>
...
### and now its time for the looong title to check if headers overflow in both the toc and the document
